...
export default function ShowroomExperience({ onOpenBookingModal }) {
  return (
    <section id="showroom" className="py-20 lg:py-28 bg-[#121316] text-[#FBF9F5] border-b border-[#2A2C33] relative overflow-hidden">
      {/* Subtle Background Glow */}
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-[#C27D56]/10 rounded-full blur-3xl pointer-events-none -translate-y-1/2" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            <div>
              ...
              <h2 className="font-display-luxury text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-[1.15]">
                Immerse Yourself in <br />
                <span className="font-serif-luxury italic font-normal text-[#DFBD69]">
                  Tactile Architectural Splendor.
                </span>
              </h2>

              <p className="mt-4 text-sm sm:text-base text-[#D9D0C3] font-light leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 bg-white/5 border border-white/10 rounded-sm">
                <div className="flex items-center gap-2 text-xs font-semibold text-white uppercase tracking-wider mb-1">
                  ...
                  Full-Scale Slab Displays
                </div>
                <p className="text-xs text-[#A8A297]">
                  Over 120 continuous bookmatched slab fixtures up to 160x320 cm.
                </p>
              </div>
              ...
              <div className="p-4 bg-white/5 border border-white/10 rounded-sm">
                <div className="flex items-center gap-2 text-xs font-semibold text-white uppercase tracking-wider mb-1">
                  <Sparkles className="w-3.5 h-3.5 text-[#C27D56]" />
                  1-on-1 Material Advisors
                </div>
                <p className="text-xs text-[#A8A297]">
                  Blueprint review, slip-rating analysis, and custom cut specifications.
                </p>
              </div>
              ...
              <div className="p-4 bg-white/5 border border-white/10 rounded-sm">
                <div className="flex items-center gap-2 text-xs font-semibold text-white uppercase tracking-wider mb-1">
                  <Sparkles className="w-3.5 h-3.5 text-[#C27D56]" />
                  Natural Lighting Simulators
                </div>
                <p className="text-xs text-[#A8A297]">
                  Adjustable Kelvins to view tile tones under morning, noon & evening light.
                </p>
              </div>
              ...
              <div className="p-4 bg-white/5 border border-white/10 rounded-sm">
                ...
                <p className="text-xs text-[#A8A297]">
                  Take home curated material boards for client and site review.
                </p>
              </div>
            </div>

            {/* Location & Visiting Hours Box */}
            <div className="p-5 bg-gradient-to-r from-white/10 to-white/5 border border-white/15 rounded-sm space-y-2 text-xs text-[#D9D0C3]">
            ...
            <div>
              <button
                ...
                className="px-8 py-4 bg-[#C27D56] hover:bg-[#A85A32] text-white text-xs font-semibold uppercase tracking-widest rounded-sm transition-all duration-300 flex items-center gap-3 shadow-xl hover:shadow-2xl"
              >
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative rounded-sm overflow-hidden border border-white/15 shadow-2xl group">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 bg-black/70 backdrop-blur-md rounded-sm border border-white/20 flex items-center justify-between">
                <div>
                  <span className="text-[10px] uppercase tracking-widest text-[#C27D56] font-semibold block">
                    Flagship Gallery
                  </span>
                ...
                <div className="text-right">
                  ...
                  <span className="text-xs text-[#DFBD69] font-semibold">Available</span>
                </div>
              </div>
            </div>
          </div>
